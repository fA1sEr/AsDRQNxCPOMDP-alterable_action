...
class mini_hall2:
    def __init__(self):
        self.file = 'GameSimulator/mini_hall2.POMDP'
        self.states = 13
        self.actions = 3
        self.observations = 9
        self.cur_state = 0
        ...
        self.p_state = [0.083337, 0.083333, 0.083333, 0.083333, 0.083333, 0.083333, 0.083333, 0.083333, 0.083333, 0.083333, 0.083333, 0.083333, 0.0]
        self.total_steps = 0
    ...
    def init_game(self):
        ...
        for line in lines:
            ...
            if line[0]=='O':
                ...
                p_obs = float(items[1].strip())
                self.O[observation][state] = p_obs
            # Rewards
            if line[0]=='R':
                items = line.split(':')
...
class GameSimulator:
    def __init__(self, frame_repeat=1):
        self.last_action = 0
        self.action_length = 3 # change two place [2]
        self.game = None
